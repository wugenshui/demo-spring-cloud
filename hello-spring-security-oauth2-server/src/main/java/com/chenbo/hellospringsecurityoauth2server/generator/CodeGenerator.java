package com.chenbo.hellospringsecurityoauth2server.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/hello-spring-security-oauth2-server";
        // 【输出文件路径】
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/oauth2?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
